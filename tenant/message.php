            ...
            <div class="messages-area" id="messagesArea">
                ...
                <?php else: ?>
                    <?php foreach ($messages as $message): ?>
                        <div class="message <?= ($message['sender'] === $role ? 'sent' : 'received') ?>">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (textarea) {
                ...
                messageForm.addEventListener('submit', function(e) {
                    ...
                    messagesArea.appendChild(tempMsg);
                    scrollToBottom();
            ...
            <?php if ($tenant_id): ?>
                setInterval(() => {
                    ...
                    .then(html => {
                        ...
                        const newMessages = doc.querySelectorAll('#messagesArea .message.received');
                        
                        if (newMessages.length > document.querySelectorAll('#messagesArea .message.received').length) {
